...
<body>
    ...
    <!-- Example: Display products in an HTML table -->
    <div class="product-table">
        <h2>Products as HTML Table</h2>
        
        <?php
        // SQL query to fetch all products
        $sql = "SELECT * FROM products";

        // Call the method to get the HTML table
        $htmlTable = $productModel->getQueryAsHtmlTable($sql);
